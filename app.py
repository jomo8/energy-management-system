...
def main() -> None:
    ...
    if b1.button("1 Day", use_container_width=True):
        st.session_state.selected_window = "1 Day"
    if b2.button("3 Day", use_container_width=True):
        st.session_state.selected_window = "3 Day"
    if b3.button("7 Day", use_container_width=True):
        st.session_state.selected_window = "7 Day"
